    ...
    <jet-authentication-card>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4">
                ...
                <select  v-model="form.gender" name="gender" id="gender" class="mt-1 block w-full border-indio-300 focus:ring focus:indio-ring-200 focus:ring-opacity-50 rounded-md shadow-sm">
